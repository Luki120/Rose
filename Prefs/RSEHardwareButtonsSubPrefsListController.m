#import "RSEHardwareButtonsSubPrefsListController.h"

BOOL enableHardwareButtonsSection = NO;

@implementation RSEHardwareButtonsSubPrefsListController
...
- (void)toggleState {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.rosepreferences.plist"]) {
        enableHardwareButtonsSection = YES;
        [preferences setBool:enableHardwareButtonsSection forKey:@"EnableHardwareButtonsSection"];
        [self toggleCellState:YES];
    } else if (![allKeys containsObject:@"EnableHardwareButtonsSection"]) {
        enableHardwareButtonsSection = YES;
        [preferences setBool:enableHardwareButtonsSection forKey:@"EnableHardwareButtonsSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnableHardwareButtonsSection"] isEqual:@(NO)]) {
        enableHardwareButtonsSection = YES;
        [preferences setBool:enableHardwareButtonsSection forKey:@"EnableHardwareButtonsSection"];
        [self toggleCellState:YES];   
    } else if ([[preferences objectForKey:@"EnableHardwareButtonsSection"] isEqual:@(YES)]) {
        enableHardwareButtonsSection = NO;
        [preferences setBool:enableHardwareButtonsSection forKey:@"EnableHardwareButtonsSection"];

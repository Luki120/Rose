#import "RSEStatusChangesSubPrefsListController.h"

BOOL enableStatusChangesSection = NO;

@implementation RSEStatusChangesSubPrefsListController
...
- (void)toggleState {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.rosepreferences.plist"]) {
        enableStatusChangesSection = YES;
        [preferences setBool:enableStatusChangesSection forKey:@"EnableStatusChangesSection"];
        [self toggleCellState:YES];
    } else if (![allKeys containsObject:@"EnableStatusChangesSection"]) {
        enableStatusChangesSection = YES;
        [preferences setBool:enableStatusChangesSection forKey:@"EnableStatusChangesSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnableStatusChangesSection"] isEqual:@(NO)]) {
        enableStatusChangesSection = YES;
        [preferences setBool:enableStatusChangesSection forKey:@"EnableStatusChangesSection"];
        [self toggleCellState:YES];   
    } else if ([[preferences objectForKey:@"EnableStatusChangesSection"] isEqual:@(YES)]) {
        enableStatusChangesSection = NO;
        [preferences setBool:enableStatusChangesSection forKey:@"EnableStatusChangesSection"];

#import "RSEAnywhereSubPrefsListController.h"

BOOL enableAnywhereSection = NO;

@implementation RSEAnywhereSubPrefsListController
...
- (void)toggleState {
    ...
    if (![[NSFileManager defaultManager] fileExistsAtPath:@"/var/mobile/Library/Preferences/love.litten.rosepreferences.plist"]) {
        enableAnywhereSection = YES;
        [preferences setBool:enableAnywhereSection forKey:@"EnableAnywhereSection"];
        [self toggleCellState:YES];
    } else if (![allKeys containsObject:@"EnableAnywhereSection"]) {
        enableAnywhereSection = YES;
        [preferences setBool:enableAnywhereSection forKey:@"EnableAnywhereSection"];
        [self toggleCellState:YES];
    } else if ([[preferences objectForKey:@"EnableAnywhereSection"] isEqual:@(NO)]) {
        enableAnywhereSection = YES;
        [preferences setBool:enableAnywhereSection forKey:@"EnableAnywhereSection"];
        [self toggleCellState:YES];   
    } else if ([[preferences objectForKey:@"EnableAnywhereSection"] isEqual:@(YES)]) {
        enableAnywhereSection = NO;
        [preferences setBool:enableAnywhereSection forKey:@"EnableAnywhereSection"];
